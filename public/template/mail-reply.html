...
<html lang="en">
	<head>
		...
		<title>Reply mail | SENTIR - Responsive admin and dashboard UI kits template</title>
		...
		<div class="wrapper">
				...
				<ul class="sidebar-menu">
					...
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="mail-reply.html">Reply mail</a></li>
						</ul>
					</li>
					<li>
						<a href="#fakelink">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					...
					<!-- BEGIN MAIL APPS REPLY -->
					<div class="mail-apps-wrap">
						<div class="the-box bg-success no-border no-margin heading">
							<div class="row">
								<div class="col-sm-6">
									<h1><i class="fa fa-envelope icon-lg icon-circle icon-bordered"></i> Mail reply</h1>
								</div><!-- /.col-sm-6 -->
						...
						<div class="the-box toolbar no-border no-margin">
							<div class="btn-toolbar" role="toolbar">
								<div class="btn-group">
									<a href="mail-inbox.html" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Back to inbox</a>
								</div>
								<div class="btn-group">
							...
							<div class="row">
								<div class="col-sm-4 col-md-3">
									<div class="list-group success square no-border">
									  <a href="mail-inbox.html" class="list-group-item active">Inbox <span class="badge badge-success">33</span></a>
									  <a href="mail-send.html" class="list-group-item">Sent mail <span class="badge badge-primary">5</span></a>
								...
								<div class="col-sm-8 col-md-9">
									<h4>SUBJECT : Lorem ipsum dolor sit amet, consectetuer adipiscing elit</h4>
									<div class="panel panel-transparent panel-square">
									  <div class="panel-heading">
										<h3 class="panel-title">
											...
											<img src="assets/img/avatar/avatar-1.jpg" class="avatar img-circle" alt="Avatar"> 
											<strong>Paris Hawker</strong> to me
										...
										<div id="read-mail-example-1" class="collapse">
												...
												<ul class="dropdown-menu">
												  <li>
													<ul class="mail-info-detail">
														<li>From : <strong>Paris Hawker</strong></li>
														<li>Email : <strong class="text-danger">someone@domain.com</strong></li>
														<li>Sent : April 20, 2014 at 11:45:56 AM</li>
														<li>Subject :  <strong class="text-info">Lorem ipsum dolor sit amet, consectetuer</strong></li>
													</ul>
												  </li>
												</ul>
											</div>
										  ...
										  <div class="panel-footer">
												...
												<button class="btn btn-info"><i class="fa fa-cloud-download"></i> Download all attachment</button>
										  </div><!-- /.panel-footer -->
										</div><!-- /.collapse in -->
									...
									<div class="panel panel-transparent panel-square">
									  <div class="panel-heading">
										<h3 class="panel-title">
											...
											me to <strong>Paris Hawker</strong>
											<span class="right-content">
											...
											<form role="form">
												<div class="form-group">
													...
													<select data-placeholder="Select people..." class="form-control chosen-select" multiple tabindex="4">
														...
														<option selected>Paris Hawker</option>
														<option>Thomas White</option>
														<option>Doina Slaivici</option>
														<option>Harry Nichols</option>
														<option>Mihaela Cihac</option>
														<option>Harold Chavez</option>
														<option>Elizabeth Owens</option>
														<option>Frank Oliver</option>
														<option>Mya Weastell</option>
														<option>Carl Rodriguez</option>
														<option>Nikita Carter</option>
														<option>Craig Dixon</option>
														<option>Mikayla King</option>
														<option>Richard Dixon</option>
														<option>Brenda Fuller</option>
														<option>Ryan Ortega</option>
														<option>Jessica Gutierrez</option>
														<option>Peter Ramirez</option>
														<option>Cynthia Mendez</option>
														<option>Jason Crawford</option>
														<option>Maria Simpson</option>
														<option>Charles Guerrero</option>
														<option>Sandra Myers</option>
														<option>Phillip Lucas</option>
														<option>Karen Wallace</option>
													</select>
												</div>
												<div class="form-group">
													<label>Cc</label>
												...
												<div class="form-group">
													<textarea class="summernote-sm">Hello Summernote</textarea>
												</div><!-- /.input-group -->
												<div class="form-group">
