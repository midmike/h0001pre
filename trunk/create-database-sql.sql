...
create table if not exists  tbfood( id int auto_increment primary key, name nvarchar(50), unitType int, prince float,createdate date, modifydate date, editedby int, cache bit);
