...
<div class="container-fluid">
	...
	<h1 class="page-heading">
		DASHBOARD <small>Sub heading here</small>
	</h1>
	<!-- End page heading -->
	...
	<div
		...
		<p class="text-muted">
			You probably here cause wanna know how is <a class="alert-link"
				href="#fakelink">Sentir UI kits template</a>, or you have purchased
			it. But whatever! I just wanna say thank you for viewing or
			purchasing my work. And let me know your feedback! <i
		...
		<div class="col-sm-3">
			<div class="the-box no-border bg-success tiles-information">
				...
				<div class="tiles-inner text-center">
					...
					<!-- /.progress .no-rounded -->
					<p>
						<small>Better than yesterday ( 7,5% )</small>
					</p>
				</div>
				<!-- /.tiles-inner -->
			</div>
		...
		<div class="col-sm-3">
			<div class="the-box no-border bg-primary tiles-information">
				...
				<div class="tiles-inner text-center">
					...
					<!-- /.progress .no-rounded -->
					<p>
						<small>Better than yesterday ( 10,5% )</small>
					</p>
				</div>
				<!-- /.tiles-inner -->
			</div>
		...
		<div class="col-sm-3">
			<div class="the-box no-border bg-danger tiles-information">
				...
				<div class="tiles-inner text-center">
					...
					<!-- /.progress .no-rounded -->
					<p>
						<small>Less than yesterday ( <span class="text-danger">-7,5%</span>
							)
						</small>
					</p>
				</div>
		...
		<div class="col-sm-3">
			<div class="the-box no-border bg-warning tiles-information">
				...
				<div class="tiles-inner text-center">
					...
					<!-- /.progress .no-rounded -->
					<p>
						<small>Better than yesterday ( 2,5% )</small>
					</p>
				</div>
				<!-- /.tiles-inner -->
			</div>
	...
	<div class="row">
		<div class="col-lg-8">
			...
			<div class="panel panel-info panel-no-border panel-square">
				<div class="panel-heading">
					<div class="right-content">
						<div class="btn-group">
							<button class="btn btn-info btn-sm active">Lifetime</button>
							<button class="btn btn-info btn-sm">This year</button>
						</div>
					</div>
				...
				<div class="the-box no-border full no-margin">
					...
					<!-- the-box no-border bg-info no-margin full -->
					...
					<!-- the-box no-border bg-dark no-margin -->
			...
			<div class="row">
				<div class="col-sm-6">
					<!-- BEGIN PROPERTY CARD -->
					<div
						class="panel panel-danger panel-square panel-no-border task-list-wrap">
						...
						<div class="the-box full no-border property-card">
							<div id="property-slide-8" class="owl-carousel">
								<div class="item full">
									<img src="assets/img/photo/small/img-15.jpg" alt="Image">
								</div>
								<div class="item full">
									<img src="assets/img/photo/small/img-16.jpg" alt="Image">
								</div>
								<div class="item full">
									<img src="assets/img/photo/small/img-17.jpg" alt="Image">
								</div>
							</div>
							...
							<!-- /.the-box .no-margin .no-border .bg-warning -->
					...
					<!-- /.panel panel-danger panel-no-border panel-square task-list-wrap -->
					<!-- END PROPERTY CARD -->
				</div>
				<!-- /.col-sm-6 -->
				<div class="col-sm-6">
					<!-- BEGIN TASK LIST -->
					<div
						class="panel panel-success panel-square panel-no-border task-list-wrap">
						<div class="panel-heading lg">
							<h3 class="panel-title">
								<i class="fa fa-check-square-o"></i> Your current tasks
							</h3>
						</div>
						<ul class="list-group">
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-1"> <label for="task-1">Eating
										woods</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-2" checked /> <label
										for="task-2">Washing my pets</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-3" checked /> <label
										for="task-3">Uploading selfie photos</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-4" checked /> <label
										for="task-4">Downloading movie</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-5"> <label for="task-5">Updating
										my <i>alay</i> status
									</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-6" checked /> <label
										for="task-6">Hunting cabe-cabean</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-7"> <label for="task-7">Creating
										web template</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-8" checked /> <label
										for="task-8">Walking to Malioboro</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-9" checked /> <label
										for="task-9">Listening Alay songs</label>
								</div> <!-- /.checkbox -->
							</li>
							<li class="list-group-item">
								<div class="checkbox">
									<input type="checkbox" id="task-10" /> <label for="task-10">Being
										an elite author</label>
								</div> <!-- /.checkbox -->
							</li>
						</ul>
						<div class="panel-footer">
							<p>
								<button class="btn btn-danger btn-perspective btn-block">See all
									tasks</button>
							</p>
						</div>
					</div>
		...
		<div class="col-lg-4">
			...
			<div class="the-box no-border" id="weather-widget-1">
				...
				<div class="weather-widget">
					<div class="row">
						...
						<!-- /.col-xs-6 -->
						<div class="col-xs-6">
							<h1 class="bolded degrees white-text">
				...
				<div class="row">
					<div class="col-xs-4 text-center">
						...
						<h4 class="bolded white-text">
							27<i class="wi-degrees"></i>
						</h4>
					</div>
					<!-- /.col-xs-4 -->
					<div class="col-xs-4 text-center">
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<div class="tiles twitter-tile text-center">
						...
						<h4>
							<a href="#fakelink">2K followers</a>
						</h4>
					</div>
					<!-- /.tiles .twitter-tile -->
				</div>
				...
				<div class="col-xs-6">
					<div class="tiles dribbble-tile text-center">
						...
						<h4>
							<a href="#fakelink">1K followers</a>
						</h4>
					</div>
					<!-- /.tiles .dribbble-tile -->
				</div>
			...
			<h4 class="small-title">
				<strong><i class="fa fa-users"></i> FRIEND REQUESTS</strong>
			</h4>

			<!-- BEGIN USER CARD LONG -->
			<div class="the-box bg-success no-border">
				<div class="media user-card-sm">
					<a class="pull-left" href="#fakelink"> <img
						class="media-object img-circle"
						src="assets/img/avatar/avatar-9.jpg" alt="Avatar">
					</a>
					...
					<div class="right-button">
						<button data-toggle="tooltip" title="Accepted"
			...
			<div class="the-box no-border">
				<div class="media user-card-sm">
					<a class="pull-left" href="#fakelink"> <img
						class="media-object img-circle"
						src="assets/img/avatar/avatar-7.jpg" alt="Avatar">
					</a>
					<div class="media-body">
					...
					<div class="right-button">
						<button data-toggle="tooltip" title="Accept" class="btn btn-info">
							<i class="fa fa-check"></i>
						</button>
					</div>
					<!-- /.right-button -->
			...
			<div class="the-box no-border">
				<div class="media user-card-sm">
					<a class="pull-left" href="#fakelink"> <img
						class="media-object img-circle"
						src="assets/img/avatar/avatar-6.jpg" alt="Avatar">
					</a>
					<div class="media-body">
	...
	<div class="row">
						...
						<div id="tiles-slide-2" class="owl-carousel tiles-carousel">
							<div class="item full">
								<img src="assets/img/avatar/avatar-1.jpg"
									class="avatar img-circle has-white-shadow" alt="avatar">
								<div class="des">
									<h4 class="bolded">
										<a href="#fakelink">Awesome headline news title</a>
									</h4>
									<p class="small">02 MAY, 2014</p>
									<p class="small">Lorem ipsum dolor sit amet, consectetuer
							...
							<!-- /.item full -->
							<div class="item full">
								<img src="assets/img/avatar/avatar-3.jpg"
									class="avatar img-circle has-white-shadow" alt="avatar">
								<div class="des">
									<h4 class="bolded">
										<a href="#fakelink">Awesome headline news title</a>
					...
					<div class="the-box no-border bg-info full">
						<div id="tiles-slide-3" class="owl-carousel tiles-carousel-color">
							<div class="item full">
								<div class="avatar-wrap">
									<div class="media">
										<a class="pull-left" href="#fakelink"> <img
											...
											class="avatar img-circle has-white-shadow media-object"
											alt="avatar">
										</a>
										<div class="media-body">
								...
								<div class="des">
									<h4 class="bolded">
										<a href="#fakelink">Awesome life story title</a>
									</h4>
									<p class="small">02 MAY, 2014</p>
									<p class="small">Lorem ipsum dolor sit amet, consectetuer
										adipiscing elit, sed diam nonummy nibh</p>
		...
		<div class="col-lg-8 col-md-12">
			...
			<div class="panel panel-success panel-square panel-no-border">
				<div class="panel-heading lg">
					<div class="right-content">
						<button class="btn btn-success to-collapse" data-toggle="collapse"
							data-target="#panel-chart-widget-1">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="row">
									...
									<div class="col-xs-6 text-center">
										...
										<span class="chart chart-widget-pie widget-easy-pie-2"
											data-percent="85"> <span class="percent"></span>
										</span>
									</div>
									<!-- /.col-xs-6 -->
								</div>
								...
								<button class="btn btn-block btn-danger">
									<i class="fa fa-cogs"></i> Resource monitor
								</button>
							</div>
							<!-- /.col-sm-6 -->
							<div class="col-sm-6">
								...
								<p class="small">
									Handles - <span class="text-danger">80%</span>
								</p>
								<div class="progress no-rounded progress-xs">
								...
								<!-- /.progress .no-rounded -->
								<p class="small">
									Threads - <span class="text-warning">65%</span>
								</p>
								<div class="progress no-rounded progress-xs">
								...
								<!-- /.progress .no-rounded -->
								<p class="small">
									Proccess - <span class="text-success">40%</span>
								</p>
								<div class="progress no-rounded progress-xs">
								...
								<!-- /.progress .no-rounded -->
								<p class="small">
									Cached - <span class="text-info">70%</span>
								</p>
								<div class="progress no-rounded progress-xs">
	...
	<h4 class="text-center small-heading more-margin-bottom">YOUR FAVORITE
		PLACES WEATHER</h4>
	...
	<div class="row">
		<div class="col-sm-3">
			...
			<div class="the-box no-border full text-center">
				<div class="the-box no-border bg-warning no-margin">
					...
					<h1 class="bolded less-distance">
						27<i class="wi-degrees"></i>
					</h1>
					<h4>It's sunny</h4>
				</div>
				<!-- /.the-box no-border bg-warning no-margin -->
				<div class="the-box no-border no-margin">
		...
		<div class="col-sm-3">
			...
			<div class="the-box no-border full text-center">
				...
				<!-- /.the-box no-border bg-danger no-margin -->
				<div class="the-box no-border no-margin">
		...
		<div class="col-sm-3">
			...
			<div class="the-box no-border full text-center">
				...
				<!-- /.the-box no-border bg-success no-margin -->
				<div class="the-box no-border no-margin">
		...
		<div class="col-sm-3">
			...
			<div class="the-box no-border full text-center">
				...
				<!-- /.the-box no-border bg-primary no-margin -->
				<div class="the-box no-border no-margin">
	...
	<!-- BEGIN CAROUSEL ITEM -->
	<div class="the-box no-border">
		<h4 class="small-heading more-margin-bottom text-center">LAST WEEK
			POPULAR ITEM</h4>
		<div id="store-item-carousel-3" class="owl-carousel shop-carousel">
			<div class="item">
				<div class="media">
					<a class="pull-left" href="#fakelink"> <img class="media-object sm"
						src="assets/img/shop/img-shop-1.jpg" alt="Image">
					</a>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="#fakelink">Product name here</a>
						</h4>
			...
			<div class="item">
				<div class="media">
					<a class="pull-left" href="#fakelink"> <img class="media-object sm"
						src="assets/img/shop/img-shop-2.jpg" alt="Image">
					</a>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="#fakelink">Product name here</a>
			...
			<div class="item">
				<div class="media">
					<a class="pull-left" href="#fakelink"> <img class="media-object sm"
						src="assets/img/shop/img-shop-3.jpg" alt="Image">
					</a>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="#fakelink">Product name here</a>
			...
			<div class="item">
				<div class="media">
					<a class="pull-left" href="#fakelink"> <img class="media-object sm"
						src="assets/img/shop/img-shop-4.jpg" alt="Image">
					</a>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="#fakelink">Product name here</a>
			...
			<div class="item">
				<div class="media">
					<a class="pull-left" href="#fakelink"> <img class="media-object sm"
						src="assets/img/shop/img-shop-5.jpg" alt="Image">
					</a>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="#fakelink">Product name here</a>
			...
			<div class="item">
				<div class="media">
					<a class="pull-left" href="#fakelink"> <img class="media-object sm"
						src="assets/img/shop/img-shop-6.jpg" alt="Image">
					</a>
					<div class="media-body">
						<h4 class="media-heading">
							<a href="#fakelink">Product name here</a>
		...
		<div class="col-sm-8">
			...
			<div class="the-box full no-border item-lg">
				<div id="store-item-carousel-2" class="owl-carousel">
					<div class="item full">
						<img src="assets/img/photo/large/img-7.jpg" class="item-image"
							alt="Image">
					</div>
					<div class="item full">
						<img src="assets/img/photo/large/img-8.jpg" class="item-image"
							alt="Image">
					</div>
				</div>
				<div class="item-des">
					<div class="the-box transparent no-margin">
						...
						<h1>
							<a href="#fakelink">You product name here</a>
						</h1>
						<h4 class="bolded">&#36;220.00</h4>
						<p class="text-muted item-des-text">Lorem ipsum dolor sit amet,
		...
		<div class="col-sm-4">
			...
			<div class="the-box no-border full">
				<div class="the-box bg-dark no-border no-margin">
					...
					<h4 class="bolded less-distance text-danger text-center">My
				...
				<div class="the-box no-border bg-danger no-margin">
					...
					<div id="tiles-slide-1" class="owl-carousel my-reminder">
						<div class="item full text-left">
							<p>Eating some sand and listening alay songs in the small hole
								under bridge</p>
							<p class="small">Wrote about a month ago</p>
						</div>
						<div class="item full">
							<p>Go to school again, do homework again, meet some best friends
								again</p>
							<p class="small">Wrote about a week ago</p>
						</div>
						<div class="item full">
							<p>Finishing all my works, time to vacation, spending time with
