...
define("EWR_PROJECT_ID", "{EDE81F86-6412-44EF-B960-EC1AD016FF62}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "ResManag", TRUE); // Project Name
define("EWR_PROJECT_VAR", "ResManag", TRUE); // Project Var
...
define("EWR_CONN_PASS", '', TRUE);
define("EWR_CONN_DB", 'resmanag', TRUE);
...
define("EWR_RANDOM_KEY", 'LQcOS0xGqYyn383O', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/ResManag.css", TRUE); // Project stylesheet file name
...
define("EWR_SERVER_VALIDATE", TRUE, TRUE);
