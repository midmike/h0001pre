...
<script type="text/javascript">
if (!window.jQuery || !jQuery.fn.alert) ewr_GetCss("../assets/css/bootstrap.min.css");
...
if (window.jQuery && !jQuery.fn.alert) ewr_GetScript("../assets/js/bootstrap.min.js");		
</script>
<?php } ?>
<?php if (@$gsExport == "") { ?>
<script type="text/javascript">
...
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ewr_ConvertFullUrl("apple-touch-icon.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ewr_ConvertFullUrl("apple-touch-icon.ico") ?>">
...
<?php if (!ewr_IsMobile()) { ?>
	...
	<div id="ewHeaderRow" class="ewHeaderRow"><img src="phprptimages/apple-touch-icon.png" alt="" style="border: 0;"></div>
	<!-- header (end) -->
<?php } ?>
<?php if (ewr_IsMobile()) { ?>
